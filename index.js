...
function CemberinAlani(yaricap, piDegeri) {
  let alan = piDegeri * Math.pow(yaricap, 2);
  return alan;
}
...
for(let sayi in sayiSayilari){
  if(sayiSayilari[sayi] > 1){
    tekraredensayilar.push(`${sayi} sayisi ${sayiSayilari[sayi]} kere tekrar edilmiştir.`)
  }
}
